...
import { ArrowLeft, ArrowRight, Flame, Star } from 'lucide-react'
...
export default function FeaturedProducts() {
  ...
  // Fade-in con IntersectionObserver (reemplaza GSAP + ScrollTrigger)
        ...
        <div className="flex flex-col items-center text-center md:flex-row md:justify-between md:items-end md:text-left mb-10 md:mb-12 gap-4">
          ...
          <div className="hidden md:flex gap-2 shrink-0">
            <button
              ...
              className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center hover:bg-matheo-blue hover:text-white hover:border-matheo-blue transition-all"
              aria-label="Anterior"
            >
              <ArrowLeft size={24} />
            </button>
        ...
        {loading ? (
            ...
            <div className="flex w-full">
              {Array.from({ length: itemsToShow || 4 }).map(
                (_, i) => (
                  ...
                  >
                    <div
                      className="bg-white rounded-xl shadow-lg border border-gray-100 flex flex-col animate-pulse"
                      style={{ height: '420px' }}
                    >
                      <div className="h-52 md:h-64 bg-gray-200 shrink-0" />
                      <div className="p-4 md:p-6 flex flex-col flex-1">
                        <div className="h-4 bg-gray-200 rounded w-1/4 mb-4" />
                        <div className="h-5 bg-gray-200 rounded w-3/4 mb-2" />
                        <div className="h-5 bg-gray-200 rounded w-1/2 mb-4" />
                        <div className="mt-auto h-10 md:h-12 bg-gray-200 rounded-xl w-full" />
                      </div>
                    </div>
                  </div>
                ),
          ...
          >
            ...
            <button
              ...
              className="md:hidden absolute left-0 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full bg-white/90 shadow-md border border-gray-200 flex items-center justify-center text-gray-700 active:bg-matheo-blue active:text-white transition-all"
              aria-label="Anterior"
            >
              <ArrowLeft size={18} />
            </button>
            <button
              ...
              className="md:hidden absolute right-0 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full bg-white/90 shadow-md border border-gray-200 flex items-center justify-center text-gray-700 active:bg-matheo-blue active:text-white transition-all"
              aria-label="Siguiente"
            >
              <ArrowRight size={18} />
            </button>
            ...
            <div className="overflow-hidden mx-4 md:mx-0">
              ...
              >
                {products.map((product) => (
                  ...
                  >
                    <div className="group bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 h-full flex flex-col border border-gray-100">
                      {/* Imagen */}
