...
export default function About() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.utils.toArray<Element>('.about-fade').forEach((el) => {
        gsap.from(el, {
  ...
  return (
    <section id="nosotros" ref={sectionRef} className="w-full">
      {/* ══════════════════════════════════════════
          1. HERO — ¿QUIÉNES SOMOS?
      ══════════════════════════════════════════ */}
      <div className="relative w-full min-h-[500px] flex flex-col items-center pt-20 justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto about-fade">
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center about-fade">
      ...
      <div className="bg-gray-50 border-y border-gray-100 py-14">
        <div className="container mx-auto px-4 about-fade">
      ...
      <div className="bg-white py-20">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center about-fade">
            ...
            {/* Imagen mascota visión — coloca tu imagen aquí */}
            <div className="order-1 lg:order-2 flex justify-center">
              <img
                src="https://res.cloudinary.com/ddtmb8l1k/image/upload/v1774823609/IMG-VISION_kk2p9v.png"
                alt="Visión Matheo"
                className="h-72 w-auto object-contain drop-shadow-2xl hover:scale-105 transition-transform duration-500"
              />
            </div>
          </div>
        </div>
      ...
      <div className="bg-gray-50 py-20">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center about-fade">
            {/* Imagen mascota misión — coloca tu imagen aquí */}
